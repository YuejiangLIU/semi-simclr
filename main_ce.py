...
def parse_option():
    ...
    parser.add_argument('--dataset', type=str, default='cifar10',
                        choices=['cifar10', 'cifar100', 'visda', 'imagenet'], help='dataset')
    ...
    # Additional
    parser.add_argument('--data_folder', default='./datasets/', type=str, help='path to dataset')
...
def set_loader(opt):
    ...
    if opt.dataset == 'cifar10':
        ...
        train_dataset = visda_dataset(opt.data_folder + '/train', train_transform)
    ...
    val_loader = torch.utils.data.DataLoader(
        val_dataset, batch_size=opt.batch_size*8, shuffle=False,
...
def set_model(opt):
    if opt.dataset == 'cifar10' or opt.dataset == 'cifar100':
        from networks.resnet_cifar import SupCEResNet
    else :
        from networks.resnet_large import SupCEResNet
